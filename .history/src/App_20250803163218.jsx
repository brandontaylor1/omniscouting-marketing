...
function App() {
  ...
  return (
    ...
    {/* About Section */}
     <section className="bg-white py-20 px-6 text-center relative z-20">
        ...
        <p className="text-gray-700 max-w-2xl mx-auto">
         ...
         {/* Features Section */}
      <section className="bg-gray-100 py-20 px-6 text-center relative z-20">
      ...
      <section className="bg-white py-20 px-6 text-center">
        ...
        <div className="flex flex-col md:flex-row justify-center gap-8">
          <div className="border rounded-lg p-8 shadow max-w-sm w-full">
            <h3 className="text-2xl font-bold mb-2">High School</h3>
            <p className="text-3xl font-semibold mb-4">$99/mo</p>
          ...
          <div className="border rounded-lg p-8 shadow max-w-sm w-full">
            ...
            <p className="text-3xl font-semibold mb-4">$299/mo</p>
            <ul className="text-gray-700 text-left list-disc list-inside space-y-2">
