...
function App() {
 ...
 return (
    <section className="relative h-screen w-screen overflow-hidden">
      ...
      />
      <div className="absolute inset-0 bg-black/70 z-10 flex flex-col items-start justify-center text-white text-center px-4">


        <img src="/images/logowhite.svg" alt="Logo" className="w-1/4" />
        <p className="max-w-lg text-left mb-6 text-lg font-neue-montreal">
