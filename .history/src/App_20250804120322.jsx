              ...
              >
                ...
                <div className="flex flex-col sm:flex-row gap-4">
                  <button 
                    ...
                    className="bg-white text-black px-6 sm:px-8 py-4 rounded-lg font-medium hover:bg-gray-300 transition"
                  >
                    Schedule a Demo
                  </button>
                  <button 
                    disabled
                    className="bg-white/10 border border-white px-6 sm:px-8 py-4 rounded-lg font-medium cursor-not-allowed opacity-60 relative group"
                  >
                    Watch Overview
