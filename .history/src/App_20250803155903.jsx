...
function App() {
 ...
 return (
    <section className="relative h-screen w-[100vw] overflow-hidden">
      <img
        src={backgroundImage}
        alt="Stadium"
        className="object-cover w-full h-full absolute inset-0"
      />
      <div className="absolute inset-0 bg-black/40 z-10 flex flex-col items-start justify-center text-white text-center px-4">
